...
public class SearchTests extends BaseTest {
    ...
    public void autocompleteSuggestionsShouldBeAvailable() {
        ...
        Assert.assertTrue(search.isAutocompleteShown(),
    ...
    public void verifyProductCountShowDropdown() {
        ...
        int displayed = search.getDisplayedProductCount();

        Assert.assertTrue(displayed <= 50,
                "Displayed products should not exceed selected Show value.");
    }
}
